...
/*
 * This header file was automatically @generated for the coughnet_kws_c20 network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 8,402,272 ops (8,345,088 macc; 54,496 comp; 2,688 add; 0 mul; 0 bitwise)
    ...
    Layer 8: 5,120 ops (5,120 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 169,216 bytes out of 442,368 bytes total (38.3%)
