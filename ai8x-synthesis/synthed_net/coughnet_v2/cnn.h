...
/*
 * This header file was automatically @generated for the coughnet_v2 network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 8,399,200 ops (8,342,016 macc; 54,496 comp; 2,688 add; 0 mul; 0 bitwise)
    ...
    Layer 8: 2,048 ops (2,048 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 166,144 bytes out of 442,368 bytes total (37.6%)
